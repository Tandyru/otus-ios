...
class RegionsResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of RegionsResponse
        //val modelInstance = RegionsResponse()
        ...
        // to test the property ``data`` - A list of RegionSummaries
        should("test `data`") {
            // uncomment below to test the property
